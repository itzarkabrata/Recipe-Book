...
export default function AddRecipeButton({}: Props) {
  ...
  return (
    ...
    <div className="flex flex-row justify-evenly items-center h-16 w-16 sm:h-16 sm:w-40 bg-yellow-400 rounded-full sm:rounded-xl cursor-pointer" onClick={showForm}>
        <div id="add-icon">
