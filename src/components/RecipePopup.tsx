...
export default function RecipePopup({ func1 }: Props) {
    ...
    return (
        <AnimatePresence>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center backdrop-blur-md">

                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }} className="flex flex-col gap-3 w-2/3 bg-orange-100 p-7 rounded-xl ">

                    <div id="back-btn" className="mb-2 cursor-pointer" onClick={closeCardPopup}>
                        Back
                    </div>
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        <div className="flex flex-col gap-4 w-1/2">
                            <div id="recipe-image-popup" className="w-11/12 rounded-xl shadow-slate-600 shadow-2xl">
                            ...
                            <div id="recipe-title-popup" className="text-3xl font-semibold">
                                Chicken Resala with white souce
                            </div>
                            <div id="recipe-ingredients-popup">
                                Maida Bally Coconut Maida Bally Coconut Maida Bally Coconut Maida Bally Coconut Maida Bally Coconut Maida
                            </div>
                        </div>

                        <div id="recipe-description-popup" className="w-1/2">
                            <div className="text-2xl font-semibold -mt-7">Description</div>
                            <div className="overflow-x-hidden overflow-y-auto h-96 mt-3">
